...
const EventDetail = () => {
    ...
    return (
        <div className="bg-senary text-white font-sans selection:bg-secondary selection:text-black">
            ...
            <motion.section
                style={{ scale }}
                className="relative h-[60vh] flex items-end p-8 md:p-20 overflow-hidden"
            >
            ...
            <section className="max-w-375 mx-auto py-32 px-8 md:px-20 grid grid-cols-1 md:grid-cols-12 gap-12 border-t border-primary/30">
                ...
                <div className="md:col-span-7">
                    ...
                    <div className="text-lg text-gray-300 leading-relaxed space-y-6 max-w-2xl">
                        ...
                        <p>
                            इस्कॉन मंदिर में आयोजित होने वाली मंगल आरती एक अत्यंत पवित्र और आध्यात्मिक अनुभव है,
                            जिसमें भक्तगण प्रभु श्रीकृष्ण और श्री श्री राधा के दिव्य दर्शन के साथ अपने दिन की शुरुआत
                            करते हैं।
                        </p>

                        <p>
                            यह आरती प्रातःकाल ब्रह्ममुहूर्त में की जाती है, जो वैदिक परंपरा में साधना और भक्ति के
                            लिए सबसे शुभ समय माना जाता है। मंदिर का वातावरण इस समय मंत्रोच्चार, घंटियों की मधुर
                            ध्वनि और हरिनाम संकीर्तन से पूर्ण रूप से भक्तिमय हो जाता है।
                        </p>

                        <p>
                            मंगल आरती के दौरान भक्त भगवान के चरणों में दीप, धूप, पुष्प और भक्ति भाव अर्पित करते हैं।
                            यह केवल एक धार्मिक अनुष्ठान ही नहीं बल्कि आत्मा को शांति और सकारात्मकता से भर देने वाला
                            आध्यात्मिक अनुभव है।
                        </p>
                ...
                <div className="md:col-span-5 flex flex-col justify-center space-y-6">
                    ...
                    <div className="p-6 border border-secondary/40 rounded-2xl bg-secondary/10">
                        ...
                        <p className="text-sm text-gray-300 font-mono uppercase">
                            प्रातः 4:30 बजे (ब्रह्ममुहूर्त)
                        </p>
                    </div>
